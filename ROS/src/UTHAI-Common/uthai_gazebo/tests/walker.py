...
class WFunc:
    ...
    def generate(self):
        ...
        self.pfn["l_ankle_roll"]=f1
        self.pfn["l_hip_roll"]=f1
        
        # f2=mirror f1 in antiphase
        f2=f1.mirror()
        #~ f2=WJFunc()
        self.afn["l_ankle_roll"]=f2
        ...
        self.pfn["l_ankle_pitch"]=f33
        
        f4=f3.mirror()
        f4.offset*=2
        f4.scale*=2
        self.pfn["l_knee_pitch"]=f4
        ...
        self.afn["l_ankle_pitch"]=f6
        
        f7=f4.clone()
        f7.scale=0
        self.afn["l_knee_pitch"]=f7
    ...
    def apply_velocity(self,angles,velocity,phase,x):
        ...
        if v>=0:
            if phase:
                angles["l_hip_roll"]-=d
                angles["l_ankle_roll"]-=d
                angles["j_thigh1_r"]+=d
                angles["j_ankle2_r"]+=d
            else:
                angles["l_hip_roll"]-=d2
                angles["l_ankle_roll"]-=d2
...
class Walker:
    ...
    def __init__(self,robot):
        ...
        self._sub_cmd_vel=rospy.Subscriber(uthai.ns+"cmd_vel",Twist,self._cb_cmd_vel,queue_size=1)
    ...
    def init_walk(self):
        ...
        if self.get_dist_to_ready()>0.02:                    
            self.uthai.set_angles_slow(self.ready_pos)        
...
if __name__=="__main__":
    ...
    uthai=Uthai()
    rospy.loginfo("Instantiating Uthai Walker")
    walker=Walker(uthai)
